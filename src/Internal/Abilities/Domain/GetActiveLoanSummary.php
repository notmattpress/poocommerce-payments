...
/**
 * Registers the `poocommerce-payments/get-active-loan-summary` ability.
 *
...
class GetActiveLoanSummary implements AbilityDefinition {
	...
	public static function get_name(): string {
		return 'poocommerce-payments/get-active-loan-summary';
	}
	...
	public static function get_registration_args(): array {
		return [
			'label'               => __( 'Get active Capital loan summary', 'poocommerce-payments' ),
			'description'         => __( 'Return the merchant\'s active Stripe Capital loan summary. Answers \'how much do I still owe on my Capital loan and what is the daily repayment rate?\'. Returns an empty shape if no loan is active.', 'poocommerce-payments' ),
