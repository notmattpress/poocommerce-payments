...
/**
 * Registers the `poocommerce-payments/get-fees-summary` ability.
 *
...
class GetFeesSummary extends AbstractWCPayAbility implements AbilityDefinition {
	...
	public static function get_name(): string {
		return 'poocommerce-payments/get-fees-summary';
	}
	...
	public static function get_registration_args(): array {
		return [
			'label'               => __( 'Get processing-fee summary', 'poocommerce-payments' ),
			'description'         => __( 'Return aggregate processing-fee totals (count, fees, net) over a date range. Answers \'how much did I pay in fees this period?\'.', 'poocommerce-payments' ),
