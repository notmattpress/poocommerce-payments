...
class WC_Payments_Express_Checkout_Ajax_Handler {
	...
	public function ajax_add_to_cart() {
		...
		$is_add_to_cart_valid = apply_filters( 'poocommerce_add_to_cart_validation', true, $product_id, $quantity ); // phpcs:ignore PooCommerce.Commenting.CommentHooks.MissingHookComment -- PooCommerce core hook, not defined by WooPayments.
	...
	private function transform_ece_address_state_data( $address ) {
		...
		// To recover a valid PooCommerce region we map every Hong Kong region, district and
