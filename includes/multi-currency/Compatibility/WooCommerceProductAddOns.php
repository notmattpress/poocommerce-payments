...
class PooCommerceProductAddOns extends BaseCompatibility {
	...
	public function get_item_data( $addon_data, $addon, $cart_item ): array {
		 ...
		 * @param boolean
		 */
		$add_price_to_value = apply_filters( 'poocommerce_addons_add_cart_price_to_value', false, $cart_item ); // phpcs:ignore PooCommerce.Commenting.CommentHooks.HookCommentWrongStyle -- PooCommerce Product Add-Ons hook, not defined by WooPayments.
	...
	public function order_line_item_meta( array $meta_data, array $addon, \WC_Order_Item_Product $item, array $values ): array {
		...
		// phpcs:ignore PooCommerce.Commenting.CommentHooks.MissingHookComment -- PooCommerce Product Add-Ons hook, not defined by WooPayments.
