...
class CurrencySwitcherWidget extends WC_Widget {
	...
	public function widget( $args, $instance ) {
		...
		// phpcs:ignore PooCommerce.Commenting.CommentHooks.MissingHookComment -- WordPress core hook, not defined by WooPayments.
		...
		<form>
			...
			<select
				...
				aria-label="<?php echo esc_attr( ! empty( $title ) ? $title : __( 'Select your currency', 'poocommerce-payments' ) ); ?>"
