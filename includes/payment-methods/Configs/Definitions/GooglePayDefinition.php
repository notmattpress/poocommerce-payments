<?php
/**
 * Google Pay Payment Method Definition
 *
...
/**
 * Class implementing the Google Pay payment method definition.
 */
class GooglePayDefinition implements PaymentMethodDefinitionInterface {
	...
	public static function get_keywords(): array {
		return [ 'google_pay', 'googlepay', 'gpay' ];
	}
	...
	public static function get_supported_currencies(): array {
		// Google Pay supports the same currencies as card payments.
	...
	public static function get_icon_url( ?string $account_country = null ): string {
		return plugins_url( 'assets/images/cards/google-pay.svg', WCPAY_PLUGIN_FILE );
	}
