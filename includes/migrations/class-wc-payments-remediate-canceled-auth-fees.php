	...
	public function remediate_order( WC_Order $order, bool $dry_run = false ): bool {
		try {
			...
			foreach ( $wcpay_refunds as $refund ) {
				...
				do_action( 'poocommerce_refund_deleted', $refund_id, $parent_order_id ); // phpcs:ignore PooCommerce.Commenting.CommentHooks.HookCommentWrongStyle -- PooCommerce core hook, not defined by WooPayments.
			}
