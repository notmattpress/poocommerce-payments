...
class WooPay_Adapted_Extensions extends IntegrationRegistry {
	...
	public function init() {
		do_action( 'poocommerce_blocks_checkout_block_registration', $this ); // phpcs:ignore PooCommerce.Commenting.CommentHooks.MissingHookComment -- PooCommerce Blocks hook, not defined by WooPayments.
	}
