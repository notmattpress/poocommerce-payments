...
class WC_Payments_Dependency_Service {
	...
	public function is_wc_admin_enabled() {
		...
		if ( ! defined( 'WC_ADMIN_VERSION_NUMBER' ) || apply_filters( 'poocommerce_admin_disabled', false ) ) { // phpcs:ignore PooCommerce.Commenting.CommentHooks.HookCommentWrongStyle -- PooCommerce core hook, not defined by WooPayments.
			return false;
		}
