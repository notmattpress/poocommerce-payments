...
To apply the change, restart your containers using `pnpm run down && pnpm run up`. In case, it's not working properly yet, ensure that you follow the PooCommerce code README.md and build the plugin there.
