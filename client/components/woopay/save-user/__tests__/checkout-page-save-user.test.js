...
describe( 'CheckoutPageSaveUser', () => {
	...
	it( 'should render the save user form when checkbox is checked for classic checkout', async () => {
		render( <CheckoutPageSaveUser /> );
	...
	it( 'should render the save user form when checkbox is checked for blocks checkout', async () => {
	...
	it( 'should not call `request` on classic checkout when checkbox is clicked', async () => {
	...
	it( 'fills the phone input on blocks checkout with phone number field fallback', async () => {
		...
		await userEvent.click( saveMyInfoCheckbox );
