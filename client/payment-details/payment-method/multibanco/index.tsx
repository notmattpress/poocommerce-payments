...
/**
 * Props interface for MultibancoDetails component
 */
interface MultibancoDetailsProps {
	charge?: Charge;
	isLoading: boolean;
}

const MultibancoDetails: React.FC< MultibancoDetailsProps > = ( {
	charge,
	isLoading,
} ) => {
...
export default MultibancoDetails;
