							...
							<div className="dispute-steps__items">
								...
								<div className="dispute-steps__item">
									...
									<div className="dispute-steps__item-action">
										<Button
											variant="secondary"
											href="https://poocommerce.com/document/woopayments/fraud-and-disputes/managing-disputes/#withdrawals"
											target="_blank"
											rel="noopener noreferrer"
										>
											{ __(
							...
							<div className="dispute-steps__items">
								...
								<div className="dispute-steps__item">
									...
									<div className="dispute-steps__item-action">
										<Button
											variant="secondary"
											href="https://poocommerce.com/document/woopayments/fraud-and-disputes/managing-disputes/#visa-compliance-disputes"
											target="_blank"
											rel="noopener noreferrer"
										>
											{ __(
							...
							<div className="dispute-steps__items">
								...
								<div className="dispute-steps__item">
									...
									<div className="dispute-steps__item-action">
										<Button
											variant="secondary"
											href="https://poocommerce.com/document/woopayments/payment-methods/buy-now-pay-later/#klarna-inquiries-returns"
											target="_blank"
											rel="noopener noreferrer"
										>
											{ __(
