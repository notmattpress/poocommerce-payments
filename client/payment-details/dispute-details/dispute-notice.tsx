	...
	if ( paymentMethod === 'klarna' && isInquiry( dispute.status ) ) {
		if ( dispute.reason === 'credit_not_processed' ) {
			...
			noticeElements.link = (
				...
				<ExternalLink href="https://poocommerce.com/document/woopayments/payment-methods/buy-now-pay-later/#klarna-inquiries-returns" />
			);
		} else {
			...
			const reasonClause =
				...
				__( 'regarding this transaction', 'poocommerce-payments' );
