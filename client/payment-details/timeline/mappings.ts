...
export const earlyFraudWarningFraudTypeMapping = {
	card_never_received: __( 'Card never received', 'poocommerce-payments' ),
	...
	made_with_lost_card: __( 'Made with lost card', 'poocommerce-payments' ),
	made_with_stolen_card: __(
		'Made with stolen card',
		'poocommerce-payments'
	),
	misc: __( 'Other', 'poocommerce-payments' ),
