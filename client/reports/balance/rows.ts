...
export const BALANCE_ROWS: BalanceRow[] = [
	{
		...
		label: __( 'Starting balance', 'poocommerce-payments' ),
		alwaysVisible: true,
		getAmount: getAmount( 'starting_balance' ),
	},
	{
		key: 'total_charges_captured',
		label: __( 'Total charges captured', 'poocommerce-payments' ),
		alwaysVisible: true,
	...
	{
		key: 'charge_fees',
		label: __( 'Charge fees', 'poocommerce-payments' ),
		depth: 2,
		getAmount: getAmount( 'charge_fees' ),
	},
	{
		key: 'dispute_fees',
		label: __( 'Dispute fees', 'poocommerce-payments' ),
		depth: 2,
		getAmount: getAmount( 'dispute_fees' ),
	},
	{
		key: 'fee_refunds',
		label: __( 'Fee refunds', 'poocommerce-payments' ),
		depth: 2,
	...
	{
		key: 'refund_failure',
		label: __( 'Refund failures', 'poocommerce-payments' ),
		depth: 1,
	...
	},
	{
		...
		label: __( 'Financing payout', 'poocommerce-payments' ),
		depth: 1,
	...
	},
	{
		...
		label: __( 'Financing paydown', 'poocommerce-payments' ),
		depth: 1,
	...
	{
		key: 'payout_fees',
		label: __( 'Payout fees', 'poocommerce-payments' ),
		depth: 1,
	...
	},
	{
		...
		label: __( 'Reader costs', 'poocommerce-payments' ),
		depth: 1,
		getAmount: getAmount( 'reader_fees' ),
	},
	{
		key: 'network_costs',
		label: __( 'Network costs', 'poocommerce-payments' ),
		depth: 1,
	...
	},
	{
		...
		label: __( 'Other adjustments', 'poocommerce-payments' ),
		depth: 1,
	...
	},
	{
		...
		label: __( 'Net balance change in the period', 'poocommerce-payments' ),
		alwaysVisible: true,
	...
	{
		key: 'ending_balance',
		label: __( 'Ending balance', 'poocommerce-payments' ),
		alwaysVisible: true,
