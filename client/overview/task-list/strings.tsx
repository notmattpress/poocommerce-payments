...
export default {
	...
	tasks: {
		no_payment_14_days: {
			...
			action_label: __( 'Set up payouts', 'poocommerce-payments' ),
		},
		no_payment_30_days: {
			title: __(
			...
			action_label: __( 'Verify bank details', 'poocommerce-payments' ),
		},
		after_payment: {
			title: __(
		...
		near_threshold: {
			title: __( 'Verify your bank details', 'poocommerce-payments' ),
			description: ( dueDate: string ): React.ReactElement => {
				return createInterpolateElement(
					sprintf(
						__(
		...
		go_live: {
			title: __( 'Set up live payments', 'poocommerce-payments' ),
			time: __( '10 minutes', 'poocommerce-payments' ),
		},
	},
};
