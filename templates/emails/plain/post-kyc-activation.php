...
echo "\n=====================================================\n\n";
echo esc_html( wp_strip_all_tags( apply_filters( 'poocommerce_email_footer_text', get_option( 'poocommerce_email_footer_text' ) ) ) ); // phpcs:ignore PooCommerce.Commenting.CommentHooks.MissingHookComment -- PooCommerce core hook, not defined by WooPayments.
