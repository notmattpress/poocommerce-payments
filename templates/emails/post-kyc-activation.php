 ...
 *
 * This template can be overridden by copying it to yourtheme/poocommerce/emails/post-kyc-activation.php.
 *
...
do_action( 'poocommerce_email_header', $content['heading'], $email ); /* phpcs:ignore PooCommerce.Commenting.CommentHooks.MissingHookComment -- PooCommerce core hook, not defined by WooPayments. */ ?>
