 ...
 *
 * This template can be overridden by copying it to yourtheme/poocommerce/emails/customer-ipp-receipt.php.
 *
...
<p><?php printf( esc_html__( 'Hi %s,', 'poocommerce-payments' ), esc_html( $order->get_billing_first_name() ) ); ?></p>
<?php /* translators: %s: Order number */ ?>
<p><?php printf( esc_html__( 'This is the receipt for your order #%s:', 'poocommerce-payments' ), esc_html( $order->get_order_number() ) ); ?></p>
