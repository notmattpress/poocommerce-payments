...
class Create_And_Confirm_Intention_Test extends WCPAY_UnitTestCase {
	...
	public function test_exception_will_throw_if_amount_parameter_is_changed_when_filter_is_applied() {
		...
		$request->apply_filters( 'cac_test_exception_will_throw_if_immutable_parameter_is_changed_when_filter_is_applied' ); // phpcs:ignore PooCommerce.Commenting.CommentHooks.MissingHookComment
	}
