...
class WCPay_Multi_Currency_PooCommerceBookings_Tests extends WCPAY_UnitTestCase {
	...
	public function test_should_convert_product_price_returns_false_if_false_passed() {
		...
		$this->assertFalse( $this->poocommerce_bookings->should_convert_product_price( false ) );
	}
	...
	public function test_should_convert_product_price_returns_false_if_cart_calls_found() {
		...
		$this->assertFalse( $this->poocommerce_bookings->should_convert_product_price( true ) );
	}
	...
	public function test_should_convert_product_price_returns_true_if_no_calls_found() {
		...
		$this->assertTrue( $this->poocommerce_bookings->should_convert_product_price( true ) );
	}
