...
class HooksProxyTest extends WCPAY_UnitTestCase {
	...
	public function test_add_filter() {
		...
		$result = apply_filters( $hook_name, 1, 2, 3 ); // phpcs:ignore PooCommerce.Commenting.CommentHooks.MissingHookComment
	...
	public function test_add_action() {
		...
		$result = do_action( $hook_name, 1, 2, 3 ); // phpcs:ignore PooCommerce.Commenting.CommentHooks.MissingHookComment
	...
	public function test_apply_filters() {
		...
		$result = $this->sut->apply_filters( $hook_name, 1, 2, 3 ); // phpcs:ignore PooCommerce.Commenting.CommentHooks.MissingHookComment
