...
class WC_Payments_Payment_Request_Session_Test extends WCPAY_UnitTestCase {
	...
	public function test_adds_tokenized_session_headers() {
		...
		$response = apply_filters( 'rest_post_dispatch', $response, rest_get_server(), $request ); // phpcs:ignore PooCommerce.Commenting.CommentHooks.HookCommentWrongStyle

		$this->assertSame( WC_Payments_Payment_Request_Session_Handler::class, apply_filters( 'poocommerce_session_handler', 'WC_Session_Handler' ) ); // phpcs:ignore PooCommerce.Commenting.CommentHooks.MissingHookComment
	...
	public function test_does_not_add_tokenized_session_headers_on_invalid_nonce() {
		...
		$this->assertNotSame( WC_Payments_Payment_Request_Session_Handler::class, apply_filters( 'poocommerce_session_handler', 'WC_Session_Handler' ) ); // phpcs:ignore PooCommerce.Commenting.CommentHooks.MissingHookComment
	...
	public function test_clears_cart_after_response_when_header_is_provided() {
		...
		$response = rest_do_request( $request );
		// manually calling 'rest_post_dispatch' because it is not called within the context of unit tests.
		apply_filters( 'rest_post_dispatch', $response, rest_get_server(), $request ); // phpcs:ignore PooCommerce.Commenting.CommentHooks.HookCommentWrongStyle
